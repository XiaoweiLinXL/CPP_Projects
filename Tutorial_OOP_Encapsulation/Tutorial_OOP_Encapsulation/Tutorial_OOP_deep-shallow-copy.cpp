...
//	}
//
//	// Shallow copy will only copy the address that the pointer points to
//	// Deep copy is to create a memory on Heap again that stores the value
//	// and use the pointer points to it
